...
config.test_exec_root = os.path.join(config.crash_blamer_obj_root, 'test')
...
# For each occurrence of a crash-blamer tool name, replace it with the full path to
